...
**AI legal aid and case dossier engine grounded in statutes, Supreme Court judgments, and government schemes for Indian citizens.**
...
> **NYAAY AI** is an intelligent civic intermediary that converts a citizen's raw, emotional description of a bureaucratic dispute into an invariant, courtroom-tested, comprehensively cited legal dossier paired with auto-generated filing documents — with **100% trace across 93 indexed Indian Bare Acts, 4,371 Supreme Court Judgments, and 21 Government Schemes, ensuring 0% hallucinated citations.**

[**🌐 Live Platform**](https://nyaay-ai-ny.vercel.app/) &nbsp;|&nbsp; [**📹 System Architecture**](#3-technical-architecture) &nbsp;|&nbsp; [**✨ Signature Capabilities**](#2-signature-capabilities--engineering-differentiators) &nbsp;|&nbsp; [**💻 Local Setup**](#4-getting-started-local-setup)
...
2. **Dense Legalese & Intimidation**: Citizens cannot map emotional grievances to precise statutory sections, legal precedents, or relevant government schemes.
3. **Expensive Legal Entry**: Consultation fees make enforcing everyday civic rights financially impractical.

### Our Approach: AI Grounded in Statutes, Judgments & Schemes
NYAAY AI is built on one foundational principle: **It never hallucinates law.** Every right, evidentiary threshold, appellate authority, and legal notice clause generated by the platform is strictly grounded in and cited back to an authentic Section of an indexed Bare Act, a Supreme Court Judgment, or a Government Scheme.
...
- Fuses semantic embeddings with exact keywords from statutes, judgments, and schemes via **Reciprocal Rank Fusion (RRF)** with corpus metadata boosting.

### 4. 🏷️ Interactive Inline Citation Pills & Token-by-Token Streaming
- Every statutory section, judgment precedent, or scheme is rendered as an interactive monospace pill (`[ACT] · §[SECTION]`).
- Hovering or clicking a citation pill reveals a popover card displaying authentic excerpts from statutes, judgments, or schemes, legal thresholds, and a one-click source inspector.
...
- Evaluates litigation risk with a side-by-side split:
  - **Your Position / Pro Se Advantage** (Statutory rights, Supreme Court precedents, scheme benefits, and remedies in green).
...
### 7. 📚 Massive Legal Corpus Ingested
- **Comprehensive Database**: To ensure bulletproof legal assistance, we have ingested a vast dataset extending beyond basic rulebooks. 
- **The Numbers**: **93** essential Acts & Statutes, **4,371** landmark Supreme Court Judgments, and **21** Government Schemes are meticulously indexed. 
- **Why it Matters**: This ensures that every piece of advice, draft, and strategy is enriched with real-world precedents and welfare provisions, making the AI a robust legal aide.

### 8. 🗣️ The Common Man's Multilingual Companion
- **True Inclusivity**: Legal assistance shouldn't be locked behind a language barrier. NYAAY AI is designed as a friendly companion for every citizen, especially those who aren't comfortable with complex English legalese.
- **Native RAG Responses**: Currently supporting **English, Hindi, Tamil, and Bengali**. If a user describes their grievance in Hindi, the RAG models seamlessly process the context and respond directly in Hindi—ensuring the law is understood in the user's native tongue.
- **Empowering the Unheard**: By speaking your language, we remove intimidation and bring actionable civic empowerment directly to your fingertips.
...
- [x] **Interactive Section Citation Pills**: Hover popover excerpts and source inspect triggers.
...
- [ ] **High Court Case Law Ingestion**: Extending retrieval to include High Court precedents alongside our existing Supreme Court judgments and statutory enactments.
...
| **Ansh Darji** | Hybrid RAG Engine, Multi-Corpus Indexing (Statutes, Judgments, Schemes), ChromaDB / BM25 Ingestion Pipeline, Document Schema Engineering |
